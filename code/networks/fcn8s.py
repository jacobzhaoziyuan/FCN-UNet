...
"""
The implementation is borrowed from: https://github.com/jhoffman/cycada_release
...
class VGG16_FCN8s(nn.Module):
    ...
    def __init__(self, num_cls=3, pretrained=True, weights_init=None,
    ...
    for v in cfg:
        if v == 'M':
            ...
            if batch_norm:
                ...
                # else:
                #     modules.insert(1,.nn.BatchNorm2d(v,affine=False)
